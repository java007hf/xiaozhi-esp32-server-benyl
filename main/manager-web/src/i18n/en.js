export default {
  ...
  'roleConfig.editSkills': 'Edit Skills',
  'roleConfig.editMcpServers': 'Edit MCP Servers',
  'roleConfig.sandbox': 'Sandbox',
  'roleConfig.sandboxTip': 'When enabled, skill commands run isolated inside a sandbox',
  'roleConfig.sandboxNetwork': 'Allow Network',
  'roleConfig.sandboxTimeout': 'Timeout (s)',
  ...
  // Extended capabilities: skills / MCP / sandbox
  'roleConfig.extendedTitle': 'Extended Capabilities',
  'roleConfig.skills': 'Skills',
  'roleConfig.uploadSkillFolder': 'Upload Skill Folder',
  'roleConfig.skillsUploadTip': 'Upload a folder containing SKILL.md, with optional py scripts; an existing folder name will be overwritten.',
  'roleConfig.skillsEmpty': 'No uploaded skills yet',
  'roleConfig.delete': 'Delete',
  'roleConfig.mcpConfig': 'MCP Config',
  'roleConfig.mcpConfigSave': 'Save MCP',
  'roleConfig.mcpConfigTip': 'Use the standard mcpServers format, e.g. {"mcpServers": {"serverName": {"command": "npx", "args": [...]}}}',
  'roleConfig.mcpConfigPlaceholder': '{"mcpServers": {"serverName": {"command": "npx", "args": ["-y", "@modelcontextprotocol/server-example"]}}}',
  'roleConfig.sandboxOn': 'Enabled',
  'roleConfig.fetchSkillsFailed': 'Failed to fetch skill list',
  'roleConfig.uploadSkillSuccess': 'Skill uploaded successfully',
  'roleConfig.uploadSkillFailed': 'Failed to upload skill',
  'roleConfig.skillsDeleteConfirm': 'Delete skill "{name}"? This also removes the script files on disk.',
  'roleConfig.deleteSuccess': 'Deleted successfully',
  'roleConfig.deleteFailed': 'Failed to delete',
  'roleConfig.fetchMcpFailed': 'Failed to fetch MCP config',
  'roleConfig.mcpConfigInvalid': 'Invalid MCP config: it must contain an mcpServers object',
  'roleConfig.mcpConfigSaveSuccess': 'MCP config saved successfully',
  'roleConfig.mcpConfigSaveFailed': 'Failed to save MCP config',
  ...
  'skillDialog.title': 'Skill Management',
  'skillDialog.skillsCount': '{count} skills configured',
  'skillDialog.skillList': 'Skill List',
  'skillDialog.add': 'Add Skill',
  'skillDialog.edit': 'Edit',
  'skillDialog.delete': 'Delete',
  'skillDialog.unnamed': 'Unnamed Skill',
  'skillDialog.noSkills': 'No skills yet, click Add on the top right',
  'skillDialog.selectOrAdd': 'Select a skill on the left or click Add',
  'skillDialog.skillName': 'Skill Name',
  'skillDialog.skillNameRequired': 'Please enter a skill name',
  'skillDialog.description': 'Description',
  'skillDialog.content': 'SKILL.md Content',
  'skillDialog.contentPlaceholder': 'Full SKILL.md (with YAML frontmatter)',
  'skillDialog.functions': 'Bound Functions',
  'skillDialog.functionsHint': 'One function name per line',
  'skillDialog.files': 'Files (JSON)',
  'skillDialog.filesHint': 'Format: {"relative/path": "file content"}',
  'skillDialog.enabled': 'Enabled',
  'skillDialog.save': 'Save',
  'skillDialog.cancel': 'Cancel',
  'skillDialog.saveConfig': 'Save Config',
  'skillDialog.deleteConfirm': 'Delete this skill?',
  'skillDialog.jsonError': 'Invalid files JSON format',
  'skillDialog.tip': 'Tip',
  'mcpServerDialog.title': 'MCP Server Management',
  'mcpServerDialog.serversCount': '{count} servers configured',
  'mcpServerDialog.serverList': 'Server List',
  'mcpServerDialog.add': 'Add Server',
  'mcpServerDialog.edit': 'Edit',
  'mcpServerDialog.delete': 'Delete',
  'mcpServerDialog.unnamed': 'Unnamed Server',
  'mcpServerDialog.noServers': 'No MCP servers yet, click Add on the top right',
  'mcpServerDialog.selectOrAdd': 'Select a server on the left or click Add',
  'mcpServerDialog.serverName': 'Server Name',
  'mcpServerDialog.serverNameRequired': 'Please enter a server name',
  'mcpServerDialog.transport': 'Transport',
  'mcpServerDialog.command': 'Command',
  'mcpServerDialog.commandPlaceholder': 'e.g. npx',
  'mcpServerDialog.args': 'Arguments',
  'mcpServerDialog.argsHint': 'One argument per line',
  'mcpServerDialog.url': 'URL',
  'mcpServerDialog.urlPlaceholder': 'e.g. http://localhost:3000/mcp',
  'mcpServerDialog.env': 'Environment (JSON)',
  'mcpServerDialog.envHint': 'Format: {"KEY": "VALUE"}',
  'mcpServerDialog.headers': 'Headers (JSON)',
  'mcpServerDialog.headersHint': 'Format: {"KEY": "VALUE"}',
  'mcpServerDialog.enabled': 'Enabled',
  'mcpServerDialog.save': 'Save',
  'mcpServerDialog.cancel': 'Cancel',
  'mcpServerDialog.saveConfig': 'Save Config',
  'mcpServerDialog.deleteConfirm': 'Delete this MCP server?',
  'mcpServerDialog.jsonError': 'Invalid JSON format',
  'mcpServerDialog.tip': 'Tip',
