export default {
  ...
  'roleConfig.editSkills': '编辑技能',
  'roleConfig.editMcpServers': '编辑MCP服务',
  'roleConfig.sandbox': '沙箱运行',
  'roleConfig.sandboxTip': '开启后，技能相关命令将在沙箱中隔离执行',
  'roleConfig.sandboxNetwork': '允许联网',
  'roleConfig.sandboxTimeout': '超时(秒)',
  ...
  // 扩展能力：技能 / MCP / 沙箱
  'roleConfig.extendedTitle': '扩展能力',
  'roleConfig.skills': '技能',
  'roleConfig.uploadSkillFolder': '上传技能文件夹',
  'roleConfig.skillsUploadTip': '上传包含 SKILL.md 的文件夹，可包含 py 脚本；同名文件夹将覆盖更新。',
  'roleConfig.skillsEmpty': '暂无已上传的技能',
  'roleConfig.delete': '删除',
  'roleConfig.mcpConfig': 'MCP 配置',
  'roleConfig.mcpConfigSave': '保存 MCP',
  'roleConfig.mcpConfigTip': '使用标准 mcpServers 格式配置 MCP 服务，例如 {"mcpServers": {"服务名": {"command": "npx", "args": [...]}}}',
  'roleConfig.mcpConfigPlaceholder': '{"mcpServers": {"服务名": {"command": "npx", "args": ["-y", "@modelcontextprotocol/server-example"]}}}',
  'roleConfig.sandboxOn': '开启',
  'roleConfig.fetchSkillsFailed': '获取技能列表失败',
  'roleConfig.uploadSkillSuccess': '技能上传成功',
  'roleConfig.uploadSkillFailed': '技能上传失败',
  'roleConfig.skillsDeleteConfirm': '确认删除技能「{name}」吗？删除后将同时移除磁盘上的脚本文件。',
  'roleConfig.deleteSuccess': '删除成功',
  'roleConfig.deleteFailed': '删除失败',
  'roleConfig.fetchMcpFailed': '获取 MCP 配置失败',
  'roleConfig.mcpConfigInvalid': 'MCP 配置格式不正确，必须包含 mcpServers 对象',
  'roleConfig.mcpConfigSaveSuccess': 'MCP 配置保存成功',
  'roleConfig.mcpConfigSaveFailed': 'MCP 配置保存失败',
  ...
  'skillDialog.title': '技能管理',
  'skillDialog.skillsCount': '已配置 {count} 个技能',
  'skillDialog.skillList': '技能列表',
  'skillDialog.add': '新增技能',
  'skillDialog.edit': '编辑',
  'skillDialog.delete': '删除',
  'skillDialog.unnamed': '未命名技能',
  'skillDialog.noSkills': '暂无技能，点击右上角新增',
  'skillDialog.selectOrAdd': '请选择左侧技能或点击新增',
  'skillDialog.skillName': '技能名称',
  'skillDialog.skillNameRequired': '请输入技能名称',
  'skillDialog.description': '技能描述',
  'skillDialog.content': 'SKILL.md 内容',
  'skillDialog.contentPlaceholder': '完整 SKILL.md（含 YAML frontmatter）',
  'skillDialog.functions': '关联函数',
  'skillDialog.functionsHint': '每行一个函数名',
  'skillDialog.files': '文件内容 (JSON)',
  'skillDialog.filesHint': '格式：{"相对路径": "文件内容"}',
  'skillDialog.enabled': '启用',
  'skillDialog.save': '保存',
  'skillDialog.cancel': '取消',
  'skillDialog.saveConfig': '保存配置',
  'skillDialog.deleteConfirm': '确定删除该技能吗？',
  'skillDialog.jsonError': '文件内容 JSON 格式有误',
  'skillDialog.tip': '提示',
  'mcpServerDialog.title': 'MCP 服务管理',
  'mcpServerDialog.serversCount': '已配置 {count} 个服务',
  'mcpServerDialog.serverList': '服务列表',
  'mcpServerDialog.add': '新增服务',
  'mcpServerDialog.edit': '编辑',
  'mcpServerDialog.delete': '删除',
  'mcpServerDialog.unnamed': '未命名服务',
  'mcpServerDialog.noServers': '暂无 MCP 服务，点击右上角新增',
  'mcpServerDialog.selectOrAdd': '请选择左侧服务或点击新增',
  'mcpServerDialog.serverName': '服务名称',
  'mcpServerDialog.serverNameRequired': '请输入服务名称',
  'mcpServerDialog.transport': '传输方式',
  'mcpServerDialog.command': '启动命令',
  'mcpServerDialog.commandPlaceholder': '如：npx',
  'mcpServerDialog.args': '启动参数',
  'mcpServerDialog.argsHint': '每行一个参数',
  'mcpServerDialog.url': '服务地址',
  'mcpServerDialog.urlPlaceholder': '如：http://localhost:3000/mcp',
  'mcpServerDialog.env': '环境变量 (JSON)',
  'mcpServerDialog.envHint': '格式：{"KEY": "VALUE"}',
  'mcpServerDialog.headers': '请求头 (JSON)',
  'mcpServerDialog.headersHint': '格式：{"KEY": "VALUE"}',
  'mcpServerDialog.enabled': '启用',
  'mcpServerDialog.save': '保存',
  'mcpServerDialog.cancel': '取消',
  'mcpServerDialog.saveConfig': '保存配置',
  'mcpServerDialog.deleteConfirm': '确定删除该 MCP 服务吗？',
  'mcpServerDialog.jsonError': 'JSON 格式有误',
  'mcpServerDialog.tip': '提示',
