export default {
  ...
  'roleConfig.editSkills': '編輯技能',
  'roleConfig.editMcpServers': '編輯MCP服務',
  'roleConfig.sandbox': '沙箱運行',
  'roleConfig.sandboxTip': '開啟後，技能相關命令將在沙箱中隔離執行',
  'roleConfig.sandboxNetwork': '允許聯網',
  'roleConfig.sandboxTimeout': '超時(秒)',
  ...
  // 擴充能力：技能 / MCP / 沙箱
  'roleConfig.extendedTitle': '擴充能力',
  'roleConfig.skills': '技能',
  'roleConfig.uploadSkillFolder': '上傳技能資料夾',
  'roleConfig.skillsUploadTip': '上傳包含 SKILL.md 的資料夾，可包含 py 腳本；同名資料夾將覆蓋更新。',
  'roleConfig.skillsEmpty': '尚無已上傳的技能',
  'roleConfig.delete': '刪除',
  'roleConfig.mcpConfig': 'MCP 配置',
  'roleConfig.mcpConfigSave': '儲存 MCP',
  'roleConfig.mcpConfigTip': '使用標準 mcpServers 格式配置 MCP 服務，例如 {"mcpServers": {"服務名": {"command": "npx", "args": [...]}}}',
  'roleConfig.mcpConfigPlaceholder': '{"mcpServers": {"服務名": {"command": "npx", "args": ["-y", "@modelcontextprotocol/server-example"]}}}',
  'roleConfig.sandboxOn': '開啟',
  'roleConfig.fetchSkillsFailed': '取得技能清單失敗',
  'roleConfig.uploadSkillSuccess': '技能上傳成功',
  'roleConfig.uploadSkillFailed': '技能上傳失敗',
  'roleConfig.skillsDeleteConfirm': '確認刪除技能「{name}」嗎？刪除後將同時移除磁碟上的腳本檔案。',
  'roleConfig.deleteSuccess': '刪除成功',
  'roleConfig.deleteFailed': '刪除失敗',
  'roleConfig.fetchMcpFailed': '取得 MCP 配置失敗',
  'roleConfig.mcpConfigInvalid': 'MCP 配置格式不正確，必須包含 mcpServers 物件',
  'roleConfig.mcpConfigSaveSuccess': 'MCP 配置儲存成功',
  'roleConfig.mcpConfigSaveFailed': 'MCP 配置儲存失敗',
  ...
  'skillDialog.skillsCount': '已配置 {count} 個技能',
  'skillDialog.skillList': '技能列表',
  'skillDialog.add': '新增技能',
  'skillDialog.edit': '編輯',
  'skillDialog.delete': '刪除',
  'skillDialog.unnamed': '未命名技能',
  'skillDialog.noSkills': '暫無技能，點擊右上角新增',
  'skillDialog.selectOrAdd': '請選擇左側技能或點擊新增',
  'skillDialog.skillName': '技能名稱',
  'skillDialog.skillNameRequired': '請輸入技能名稱',
  'skillDialog.description': '技能描述',
  'skillDialog.content': 'SKILL.md 內容',
  'skillDialog.contentPlaceholder': '完整 SKILL.md（含 YAML frontmatter）',
  'skillDialog.functions': '關聯函數',
  'skillDialog.functionsHint': '每行一個函數名',
  'skillDialog.files': '文件內容 (JSON)',
  'skillDialog.filesHint': '格式：{"相對路徑": "文件內容"}',
  'skillDialog.enabled': '啟用',
  'skillDialog.save': '保存',
  'skillDialog.cancel': '取消',
  'skillDialog.saveConfig': '保存配置',
  'skillDialog.deleteConfirm': '確定刪除該技能嗎？',
  'skillDialog.jsonError': '文件內容 JSON 格式有誤',
  'skillDialog.tip': '提示',
  'mcpServerDialog.title': 'MCP 服務管理',
  'mcpServerDialog.serversCount': '已配置 {count} 個服務',
  'mcpServerDialog.serverList': '服務列表',
  'mcpServerDialog.add': '新增服務',
  'mcpServerDialog.edit': '編輯',
  'mcpServerDialog.delete': '刪除',
  'mcpServerDialog.unnamed': '未命名服務',
  'mcpServerDialog.noServers': '暫無 MCP 服務，點擊右上角新增',
  'mcpServerDialog.selectOrAdd': '請選擇左側服務或點擊新增',
  'mcpServerDialog.serverName': '服務名稱',
  'mcpServerDialog.serverNameRequired': '請輸入服務名稱',
  'mcpServerDialog.transport': '傳輸方式',
  'mcpServerDialog.command': '啟動命令',
  'mcpServerDialog.commandPlaceholder': '如：npx',
  'mcpServerDialog.args': '啟動參數',
  'mcpServerDialog.argsHint': '每行一個參數',
  'mcpServerDialog.url': '服務地址',
  'mcpServerDialog.urlPlaceholder': '如：http://localhost:3000/mcp',
  'mcpServerDialog.env': '環境變量 (JSON)',
  'mcpServerDialog.envHint': '格式：{"KEY": "VALUE"}',
  'mcpServerDialog.headers': '請求頭 (JSON)',
  'mcpServerDialog.headersHint': '格式：{"KEY": "VALUE"}',
  'mcpServerDialog.enabled': '啟用',
  'mcpServerDialog.save': '保存',
  'mcpServerDialog.cancel': '取消',
  'mcpServerDialog.saveConfig': '保存配置',
  'mcpServerDialog.deleteConfirm': '確定刪除該 MCP 服務嗎？',
  'mcpServerDialog.jsonError': 'JSON 格式有誤',
